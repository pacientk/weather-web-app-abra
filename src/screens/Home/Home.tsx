...
import { currentCityDataSelector, isLoadingSelector, isInitialSelector, initStateSelector, currentDaylyForecastSelector, degreeTypeSelector } from '../../store/selectors';
